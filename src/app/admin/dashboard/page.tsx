...
export default function DashboardPage() {
    ...
    const statCards = [
        { name: 'العملاء', value: stats.clients, icon: Users, color: 'text-blue-400', bg: 'bg-blue-500/10' },
        { name: 'العروض المفتوحة', value: stats.offers, icon: FileText, color: 'text-yellow-400', bg: 'bg-yellow-500/10' },
        { name: 'إجمالي الفواتير', value: stats.invoices, icon: Receipt, color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
        { name: 'المشاريع والإنجازات', value: stats.achievements, icon: Layers, color: 'text-brand-red', bg: 'bg-brand-red/10' },
    ];
        ...
        <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-white/50 mt-1">نظرة عامة على أعمال وكالة Afrikyia</p>
                </div>
                ...
                {statCards.map((stat, i) => (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="text-xs text-white/50 font-medium">{stat.name}</div>
                        </div>
                    </motion.div>
                ))}
            </div>
